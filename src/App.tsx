...
class App extends Component<any, any> {
  ...
  render() {
    ...
    let loginButtonState =
      this.state.userName === ""
        ? "button is-light"
        : "button is-light is-hidden"
    let logoutButtonState =
      this.state.userName === ""
        ? "button is-light is-hidden"
        : "button is-light"
    return (
      <div>
        <Router>
          ...
          >
            <div className="navbar-brand">
              <a className="navbar-item" href="/">
                <img src={phrLogo} width="114" height="28" />
              </a>
            ...
            <div
              ...
              className={
                navBarMenuEnable ? "navbar-menu is-active" : "navbar-menu"
              }
            >
              <div className="navbar-start kanitlight">
                ...
                <Link to="/edit-range" className="navbar-item">
                  แก้เกณฑ์การวิเคราะห์
                </Link>
              ...
              <div className="navbar-end">
                <div className="navbar-item">
                  <div className="buttons kanit">
                    ...
                    <Link to="" className={loginButtonState}>
                      ล็อกอิน
                    </Link>
                    <Link
                      to=""
                      onClick={this.logoutHandle}
                      className={logoutButtonState}
                    >
                      ออกจากระบบ
                    </Link>
                  </div>
          ...
          <div className="section">{displayAreaMember}</div>
        </Router>
        <div>
          <hr />
          <p className="kanitlight acenter">
            {" "}
            Made with love from Centre for Network Research Computer
