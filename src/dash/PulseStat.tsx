    ...
    firestore
      ...
      .then((snapshot) => {
        ...
        snapshot.forEach((doc) => {
          ...
          if (data.value >= 60 && data.value <= 80) safe++
          else if (data.value > 80 && data.value <= 100) risk++
          else if (data.value > 100) danger++
          else other++
    ...
    return (
      <div className="card">
        ...
        <div className="card-content">
          ...
          <label className="label">
            อื่น ๆ {other} รายการ (
            {this.percentCalculate(other, amount).toFixed(2)} % ){" "}
          </label>
